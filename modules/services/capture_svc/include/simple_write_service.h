...
public:
    ...
    void execute() {
        ...
        spdlog::debug("SimpleWriteService::execute. imageEvent.img.type() = ", imageEvent.img.type());
        spdlog::debug("SimpleWriteService::execute. fullScaleImage.type() = ", fullScaleImage.type());
